...
export default function ActionHeader () {
  ...
  return (
    <Stack sx={FlexStyle.RowJustifyBetweenAlignCenter}>
      <Typography variant='subtitle2' textTransform='uppercase'>Acciones de Anuncios</Typography>
      <BlueButton startIcon={<AddIcon/>} variant='contained' onClick={() => setWhichDialogIsOpen('submit-announcement')}>Agregar Anuncio</BlueButton>
    </Stack>
  )
}
